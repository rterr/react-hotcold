...
/***/ function(module, exports, __webpack_require__) {
	...
	var reducers = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameController = function gameController(state, action) {
	  ...
	  if (action.type === actions.MAKE_GUESS) {
	    ...
	    var diffNum = Math.abs(state.randNum - userNum);
	    if (diffNum >= 50) {
	      numRating = 'Ice cold';
	    ...
	    var afterSet = initSet.concat(userNum);
	
	    var guessCounter = state.guessCount++;
	
	    var newState = update(state, {
	      numHotness: numRating,
	      guessSet: afterSet,
...
/***/ }
/******/ ]);
//# sourceMappingURL=redux-hot-cold.1.0.0.js.map